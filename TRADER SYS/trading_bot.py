...
class TradingBot:
    ...
    def _persist_position(self, position: Position) -> None:
        ...
        self.config.position_state_path.parent.mkdir(parents=True, exist_ok=True)
        self.config.position_state_path.write_text(json.dumps(data))
    ...
    def _recover_state(self) -> None:
        ...
        If a Position was open:
            ...
            - Restores available_budget from Position.remaining_balance
              (the value already captured at entry — not re-derived).
        ...
        artifact case.
        """
        self.open_position = self._load_persisted_position()
        ...
        for path in all_paths:
            ...
            logger.info("TradingBot: removed orphaned artifact %s found during recovery", aid)
